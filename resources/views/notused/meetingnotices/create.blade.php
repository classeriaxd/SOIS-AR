...
@section('content')
<div class="container">
    <form action="/n" enctype="multipart/form-data" method="POST" id="MeetingNoticeForm">
        @csrf
        <div class="row">
            <div class="col-8 offset-2">
                <h2 class="text-center">Add New Meeting Notice</h2>
                ...
                <div class="form-group row">
                    ...
                    autocomplete= "creation_date"></input>
                    @error('creation_date')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group row">
                    ...
                    name="meeting_date" 
                    value="{{ old('meeting_date') }}" autocomplete="meeting_date">
                    @error('meeting_date')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group row">
                    ...
                    name="objectives" 
                    value="{{ old('objectives') }}" autocomplete= "objectives">
                    @error('objectives')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="row pt-4">
                    <button class="btn btn-primary" type='submit'>Add Meeting Notice</button>
                </div>
            </div>
        </div>
    </form>
