                    ...
                    @role('User')
                        <div class="card w-100 mb-3">
                            ...
                            <div class="card-body">
                                ...
                                @else
                                    <p class="text-center">No Accomplishment found :(. You can create one <a href="{{route('studentAccomplishment.create')}}"><u>here</u></a>.</p>
                                @endif
                    ...
                    @role('AR Officer Admin')
                        <div class="card w-100 my-3">
                            ...
                            <div class="card-body">
                                ...
                                @else
                                    <p class="text-center">No Accomplishment Submission found!</p>
                                @endif
