...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center">
        {{-- Title --}}
        <h2 class="display-7 text-left text-break">New Event Report from GPOA</h2>
        {{-- Breadcrumbs --}}
        <nav aria-label="breadcrumb align-items-center">
            <ol class="breadcrumb justify-content-center">
                ...
                <li class="breadcrumb-item">
                    <a href="{{route('event.gpoa.index')}}" class="text-decoration-none">GPOA Events</a>
                </li>
    ...
    <div class="text-center">
        <h6>The fields in blue are prefilled from the GPOA Entry. You can edit those fields if they are not sufficient/relevant.</h6>
    </div>
    ...
    >
        <div class="row">
            <div class="col">
                ...
                <div class="card mb-2">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="title" class="col-md-4 col-form-label text-primary">Title<span class="required">*</span></label>
                            <input id="title" 
                            type="text" 
                            class="form-control @error('title') is-invalid @enderror" 
                            name="title"
                            placeholder="The Event's Title" 
                            value="{{ $accomplishedEvent->title }}" 
                            autofocus 
                            required>
                        ...
                        {{-- Event Objective --}}
                        <div class="form-group row">
                            <label for="objective" class="col-md-4 col-form-label text-primary">Objective<span class="required">*</span></label>
                            <textarea id="objective" 
                            class="form-control @error('objective') is-invalid @enderror" 
                            name="objective" 
                            placeholder="The Event's Objective" 
                            required>{{ $accomplishedEvent->objectives }}</textarea>
                ...
                <div class="card mb-2">
                    ...
                    <div class="card-body">
                        ...
                        {{-- Event Venue --}}
                        <div class="form-group row">
                            <label for="venue" class="col-md-4 col-form-label text-primary">Venue<span class="required">*</span></label>
                            <input id="venue" 
                            type="text" 
                            class="form-control @error('venue') is-invalid @enderror" 
                            name="venue"
                            placeholder="The Event's Venue (ex. Zoom or Facebook Live)"  
                            value="{{ $accomplishedEvent->venue }}">
                        ...
                        {{-- Event Activity Type --}}
                        <div class="form-group row">
                            <label for="activityType" class="col-md-4 col-form-label text-primary">Type of Activity<span class="required">*</span></label>
                            ...
                            value="{{ $accomplishedEvent->activity_type }}">
                        ...
                        {{-- Event Beneficiaries --}}
                        <div class="form-group row">
                                <label for="beneficiaries" class="col-md-4 col-form-label text-primary">Event Beneficiaries<span class="required">*</span></label>
                                ...
                                required
                                value="{{ $accomplishedEvent->participants }}">
                        ...
                        {{-- Event Sponsors --}}
                        <div class="form-group row">
                            <label for="sponsors" class="col-md-4 col-form-label text-primary">Sponsors</label>
                            <input id="sponsors" 
                            type="text" 
                            class="form-control @error('sponsors') is-invalid @enderror" 
                            name="sponsors" 
                            placeholder="The Event's Sponsors" 
                            value="{{ $accomplishedEvent->sponsor ?? '' }}">
                        ...
                        {{-- Event Budget --}}
                        <div class="form-group row">
                            <label for="budget" class="col-md-4 col-form-label text-primary">Event Budget</label>
                            ...
                            <div class="input-group w-100">
                                ...
                                value="{{ $accomplishedEvent->projected_budget ?? '' }}">
                            </div>
                ...
                <div class="card">
                    ...
                    <div class=card-body>
                        ...
                        <div class="form-group row">
                            {{-- Start Date --}}
                            <div class="col">
                                <label for="startDate" class="col-md-4 form-label text-primary">Start Date<span class="required">*</span></label>
                                <input id="startDate" 
                                type="date" 
                                class="form-control @error('startDate') is-invalid @enderror" 
                                name="startDate" 
                                value="{{ date_format(date_create($accomplishedEvent->date), 'Y-m-d') }}" 
                                min="1992-01-01" 
                                required>
                                @error('startDate')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            {{-- End Date --}}
                            <div class="col">
                                <label for="endDate" class="col-md-4 form-label text-primary">End Date<span class="required">*</span></label>
                                <input id="endDate" 
                                type="date" 
                        ...
                        <div class="form-group row">
                            {{-- Start Time --}}
                            <div class="col">
                                <label for="startTime" class="col-md-4 col-form-label text-primary">Start Time<span class="required">*</span></label>
                                <input id="startTime" 
                                type="time" 
                                class="form-control @error('startTime') is-invalid @enderror" 
                                name="startTime" 
                                value="{{ date_format(date_create($accomplishedEvent->time), 'H:i') }}">
                                @error('startTime')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            {{-- End Time --}}
                            <div class="col">
                                <label for="endTime" class="col-md-4 col-form-label text-primary">End Time<span class="required">*</span></label>
                                <input id="endTime" 
                                type="time" 
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col">
                                <label for="radioFundSourceGroup" class="form-label @error('fundSource') text-danger @enderror">What was the Organization's Fund Source for this Event?<span class="required">*</span>
                                <span class="text-primary">(GPOA Fund Source:{{$accomplishedEvent->fund_source}})</span>
                                </label>
                            </div>
           ...
           <div class="flex-row my-2 text-center">
                @csrf
                <input type="hidden" name="gpoa" value="{{$accomplishedEvent->upcoming_event_id}}">
