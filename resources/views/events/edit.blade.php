...
<div class="container-fluid">
    ...
    <div class="row">
    	{{-- Title --}}
    	<h4 class="display-5 text-center">{{ $event->title }}</h4>
    	<p class="text-center">Edit Event</p>
    	{{-- Breadcrumbs --}}
    ...
    onsubmit="document.getElementById('submitButton').disabled=true;">
	    ...
	    <div class="row">
            ...
            <div class="col">
	            ...
	            <hr>
    	            ...
    	            <div class="form-group row">
    	                <div class="col">
    	                    <label for="radioEventRoleGroup" class="form-label">What was the Organization's Role in this Event?<span class="required">*</span></label></div>
    	            ...
    	            <div class="form-group row">
    	                <div class="col">
    	                    <label for="radioEventCategoryGroup" class="form-label">Event Category<span class="required">*</span></label>
    	                </div>
    	            ...
    	            <div class="form-group row">
    	                <div class="col">
    	                    <label for="radioEventClassificationGroup" class="form-label">Event Classification<span class="required">*</span></label>
    	                </div>
    	            ...
    	            <div class="form-group row">
    	                <div class="col">
    	                    <label for="radioEventNatureGroup" class="form-label">Event Nature<span class="required">*</span></label>
    	                </div>
        ...
        <div class="flex-row my-2 text-center">
            <button id="submitButton" class="btn btn-primary text-white col-md-12" type="submit"><i class="fas fa-edit"></i> Finalize Edit</button>
        </div>
    </form>
    ...
    <div class="flex-row my-2 text-center">
        <a href="{{route('event.show', ['event_slug' => $event->slug])}}"
            ...
            role="button">
            <i class="fas fa-arrow-left"></i> Go Back to <span class="text-truncate">{{ $event->title }}</span>
        </a>
