                        ...
                        <nav class="navbar navbar-expand-lg">
                            <div class="container-fluid">
                                <a class="navbar-brand" href="{{ url('/home') }}">
                                    <h3><img src="/images/pupt_logo.png" class="img-fluid"/><span>SOIS-AR | Welcome {{ Auth::user()->first_name }}!</span></h3>
                                </a>
                                ...
                                <!-- Menu -->
                                <div class="collapse navbar-collapse d-lg-block d-xl-block d-sm-none d-md-none d-none justify-content-between" id="navbarSupportedContent">
