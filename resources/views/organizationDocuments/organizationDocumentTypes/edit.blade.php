    ...
    <form action="{{ route('maintenances.organizationDocumentTypes.update', ['organizationSlug' => $organization->organization_slug, 'organizationDocumentTypeSlug' => $organizationDocumentType->slug]) }}" enctype="multipart/form-data" method="POST" id="organizationDocumentTypeUpdateForm">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <nav aria-label="breadcrumb align-items-center">
                        <ol class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{route('maintenances.organizationDocumentTypes.show', ['organizationSlug' => $organization->organization_slug, 'organizationDocumentTypeSlug' => $organizationDocumentType->slug])}}" class="text-decoration-none">{{ $organizationDocumentType->type}}</a>
                            </li>
                ...
                <div class="card mb-3">
                    <h5 class="card-header card-title text-center bg-maroon text-white fw-bold">Edit Document Type</h5>
                    <div class="card-body">
                        <div class="form-group row my-1">
                            ...
                            <input id="documentType" 
                                ...
                                value="{{ $organizationDocumentType->type }}" 
                                required>
                            @error('documentType')
