...
{
    protected $saveDirectory = '/public/compiledDocuments/accomplishmentReports/';
    /**
    ...
    public function generate($events, $studentAccomplishments)
    {
        ...
        Excel::store(new AccomplishmentReportExport($tables, $table1, $table2, $table3, $table4), $this->saveDirectory . $finalFolderName . '/' . $finalFileName);
